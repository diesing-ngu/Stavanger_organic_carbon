...
jpeg(filename = here("delta13c", "figures", "geodist_plot.jpg"), width = 15, height = 10, units = "cm", res = 300)
p
dev.off()
```
...
jpeg(filename = here("delta13c", "figures", "correlation_plot.jpg"), width = 24, height = 24, units = "cm", res = 300)
corrplot.mixed(cor(rm_resp[, names(predictors)]), lower.col =  "black", tl.pos = "lt", number.cex = 0.6)
dev.off()
```
